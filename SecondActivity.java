...
public class SecondActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> paireddeviceInfo = new ArrayAdapter<String>(this, R.layout.list_layout, pairedlist);
        ...
        ArrayAdapter<String> unpaireddeviceInfo = new ArrayAdapter<String>(this, R.layout.list_layout, unpairedlist);
